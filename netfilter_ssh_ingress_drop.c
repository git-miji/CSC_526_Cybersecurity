...
/* Dropping inbound SSH Traffic */

	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(22) && iph->saddr == in_aton("10.0.2.7") && iph->daddr == in_aton("10.0.2.6"))
	{
...
int setupFilter(void)
	...
	Net_Filter_Hook.hooknum = NF_INET_PRE_ROUTING; /* First hook for IPv4 */
